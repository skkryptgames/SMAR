...
public class ClientTasks extends AppCompatActivity {
    ActionBar toolbar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(ClientTasks.this,
                LinearLayoutManager.VERTICAL, false);
        clientRecyclerView.setLayoutManager(mLinearLayoutManager);

        clientAdapter=new ClientAdapterNoClick(ClientTasks.this,clientData);
        ...
        clientRecyclerView.addItemDecoration(new DividerItemDecoration(ClientTasks.this,
